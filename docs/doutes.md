...
- **D29 — L'aire d'intérêt par *proximité* ≠ par *pertinence sociale*.** 🟠 *Voir « les 32 plus proches » n'est pas
  ...
  *Limite assumée :* on ne classe pas ce qu'on ne perçoit pas encore, et un plafond physique demeure à 55 000 — il
  devient simplement **intelligent**. **Avancée mesurée (30 juin) :** le niveau T1 est **câblé et prouvé en banc,
  bout-en-bout** — chaque joueur peut annoncer « je suis engagé avec {quelques identités} » (message **signé**, séparé
  du flux d'état pour ne pas alourdir le chemin chaud), et la sélection en tient compte par transitivité : dans une
  foule qui grossit, un **partenaire éloigné garde le plein débit** (20 Hz, plat) là où la sélection par proximité
  seule l'affamait progressivement — jusqu'à **×100 d'écart de fidélité**. *Limite honnête : prouvé sur un banc à
  réseau parfait ; les conditions réelles (latence, perte, NAT) restent à mesurer — le statut ne bouge pas tant que
  ce n'est pas vu dehors.*
- **D30 — Le niveau de détail n'est pas adaptatif, et la foule n'a jamais été *rendue*.** 🟠 *Le système passe
  ...
  chacun, avec **visibilité mutuelle garantie** pour les paires qui interagissent. **Avancée (30 juin) :** la brique
  « qui est pertinent » est posée et mesurée (cf. D29) ; la dégradation continue et la foule *rendue* — le cœur de ce
  doute — restent entières.
